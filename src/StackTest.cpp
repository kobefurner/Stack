...
bool testEdgeCases(){
   ...
   Stack<int> intStack;
   intStack.push(9);
   passed &= checkTest("EdgeCases 1", intStack.topPop(), 9);
   intStack.push(8);
   intStack.push(7);
   intStack.push(6);
   passed &= checkTest("EdgeCases 2", intStack.topPop(), 6);
   intStack.push(5);
   intStack.push(4);
   intStack.push(3);
   intStack.pop(2);
   passed &= checkTest("EdgeCases 3", intStack.size(), 3);
   passed &= checkTest("EdgeCases 4", intStack.top(), 5);
   intStack.push(1);
   intStack.pop(3);
   passed &= checkTest("EdgeCases 5", intStack.size(), 1);
   passed &= checkTest("EdgeCases 6", intStack.top(), 8);
   ...
   passed &= checkTest("EdgeCases 9", intStack.size(), 0);
   passed &= checkTest("EdgeCases 10", intStack.empty(), true);
   intStack.pop(3); //pop an empty list
   passed &= checkTest("EdgeCases 11", string("No errors"), string("No errors"));
   passed &= checkTest("EdgeCases 12", intStack.size(), 0);
   passed &= checkTest("EdgeCases 13", intStack.empty(), true);
   try{
      intStack.top();
      passed &= checkTest("EdgeCases 14", string("No error"), string("logic_error"));
   }
   catch(logic_error& e){
      passed &= checkTest("EdgeCases 14", string("logic_error"), string("logic_error"));
   }
   try{
      intStack.topPop();
      passed &= checkTest("EdgeCases 15", string("No error"), string("logic_error"));
   }
   catch(logic_error& e){
      passed &= checkTest("EdgeCases 15", string("logic_error"), string("logic_error"));
   }
